...
namespace Cedeira.Essentials.NET_unittests.System.Security.Cryptography.Hash.Factories
{
    ...
    {
        private IHashHandlerResultPatternFactory _hashHandlerResultPatternfactory;
        private IHashContext _hashContext;
        private IResultFactory _resultFactory;
        private Dictionary<string, (string inputName, HashAlgorithmName algorithmName, Func<byte[], string>? hashformatter, bool expectedState, string expectedHash)> _TestHashResultPatternFactoryInputString;
        private Dictionary<string, (byte[] inputByte, HashAlgorithmName algorithmName, Func<byte[], string>? hashformatter, bool expectedState, string expectedHash)> _TestHashResultPatternFactoryInputByte;
        ...
        public void SetUp()
        {
            ...
            _hashHandlerResultPatternfactory = new HashHandlerResultPatternFactory(_resultFactory);
        ...
        {
            _TestHashResultPatternFactoryInputString = new Dictionary<string, (string inputName, HashAlgorithmName algorithmName, Func<byte[], string>? hashformatter, bool expectedState, string expectedHash)>
            {
            ...
            foreach (var test in _TestHashResultPatternFactoryInputString)
            {
                ...
                _service.AddSingleton(sp => _hashHandlerResultPatternfactory.CreateHash(sp.GetRequiredService<IHashContext>()));
        ...
        {
            _TestHashResultPatternFactoryInputByte = new Dictionary<string, (byte[] inputByte, HashAlgorithmName algorithmName, Func<byte[], string>? hashformatter, bool expectedState, string expectedHash)>
            {
            ...
            foreach (var test in _TestHashResultPatternFactoryInputByte)
            {
                ...
                _service.AddSingleton(sp => _hashHandlerResultPatternfactory.CreateHashWithOutPutFormat(sp.GetRequiredService<IHashContext>()));
